      ...
      <section className="container relative px-6 py-10">
        <div className="mx-auto flex max-w-6xl flex-col items-center gap-10 text-center">
          ...
          <div className="flex flex-col items-center gap-4 sm:flex-row">
            <Link
              href="/docs"
              className="inline-flex h-12 items-center justify-center rounded-lg bg-fd-primary px-10 text-base font-medium text-fd-primary-foreground shadow-lg shadow-fd-primary/25 transition-all hover:scale-105 hover:shadow-xl hover:shadow-fd-primary/30"
            >
              Get Started →
            </Link>
            <a
              ...
              className="inline-flex h-12 items-center justify-center gap-2 rounded-lg border border-fd-border bg-fd-card/80 px-10 text-base font-medium backdrop-blur-sm transition-all hover:bg-fd-accent hover:scale-105"
            >
        ...
        <div className="mx-auto max-w-6xl space-y-16">
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            {features.map((feature, index) => (
              <div
                key={index}
                className="group relative overflow-hidden rounded-2xl border border-fd-border bg-fd-card p-8 transition-all"
              >
                <div className="absolute -right-8 -top-8 size-32 rounded-full bg-fd-primary/5 blur-2xl transition-all group-hover:bg-fd-primary/10" />
                <div className="relative space-y-4">
                  <div className="flex size-14 items-center justify-center rounded-xl bg-fd-primary/10 text-fd-primary ring-1 ring-fd-primary/20">
        ...
        <div className="mx-auto max-w-6xl space-y-16">
          ...
          <div className="grid gap-8 md:grid-cols-3">
            {stackCategories.map((category, index) => (
              <div
                key={index}
                className="group relative overflow-hidden rounded-2xl border border-fd-border bg-fd-card p-8 transition-all hover:shadow-xl"
              >
                <div className="absolute -right-4 -top-4 size-24 rounded-full bg-fd-primary/5 blur-xl transition-all group-hover:scale-150" />
                <div className="relative space-y-6">
                  <div className="flex items-center gap-4">
                    <div className="flex size-12 items-center justify-center rounded-xl bg-fd-primary/10 text-fd-primary ring-1 ring-fd-primary/20">
            ...
            {stats.map((stat, index) => (
              <div key={index} className="group relative">
                <div className="relative flex flex-col items-center justify-center rounded-2xl border border-fd-border bg-fd-card p-8 text-center">
                  <div className="mb-2 text-5xl font-bold bg-linear-to-br from-fd-primary to-fd-primary/60 bg-clip-text text-transparent">
                    {stat.value}
                  </div>
          ...
          <div className="relative overflow-hidden rounded-3xl border border-fd-border bg-fd-card/50 p-12 text-center backdrop-blur-sm md:p-16">
            ...
            <div className="relative space-y-8">
              ...
              <div className="flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
                ...
                <Link
                  href="/docs"
                  className="inline-flex h-12 items-center justify-center rounded-lg border border-fd-border bg-fd-card/80 px-10 text-base font-medium backdrop-blur-sm transition-all hover:scale-105 hover:bg-fd-accent"
                >
                  Read Documentation
                </Link>
              </div>
