...
<Callout type="info">
  Once your project is generated, you can delete StackKit entirely from your system. Your project
  will continue to work perfectly because it only depends on the libraries you chose.
</Callout>
