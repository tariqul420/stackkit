...
Update Node.js to version 20 or higher. We recommend using a version manager like [nvm](https://github.com/nvm-sh/nvm) or [fnm](https://github.com/Schniz/fnm).

<Callout type="info">
  If doctor shows warnings but no errors, your project will still work — warnings are informational
  and suggest improvements rather than blocking issues.
</Callout>
...
<Callout type="info">Run `doctor` regularly to catch configuration drift.</Callout>
