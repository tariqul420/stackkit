...
<Tabs items={["npm", "pnpm", "yarn", "bun"]}>
  <Tab value="npm">```bash npx stackkit@latest create my-app ```</Tab>
  <Tab value="pnpm">```bash pnpm dlx stackkit@latest create my-app ```</Tab>
  <Tab value="yarn">```bash yarn dlx stackkit@latest create my-app ```</Tab>
  <Tab value="bun">```bash bun x stackkit@latest create my-app ```</Tab>
</Tabs>
...
<Callout type="warn">
  Never commit your `.env` file to version control. A `.gitignore` entry is already included, but
