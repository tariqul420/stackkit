...
Auth.js (formerly NextAuth.js) is a complete open source authentication solution for Next.js applications.
...
Auth.js uses Prisma adapter for database integration. The CLI automatically adds the required models to your `prisma/schema.prisma`.
...
| **UI Components** | Manual | Manual |
| **Customization** | High | High |
| **Free Tier** | Unlimited | Unlimited |
| **Edge Runtime** | Yes | Yes |
| **Self-hosted** | Yes | Yes |
| **TypeScript** | Excellent | Good |
| **OAuth Providers** | Built-in | Extensive |
