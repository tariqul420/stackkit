...
StackKit currently supports two authentication providers:

### Better Auth

Modern authentication library built for TypeScript with excellent developer experience.
...
Complete user management platform with beautiful pre-built UI components.
