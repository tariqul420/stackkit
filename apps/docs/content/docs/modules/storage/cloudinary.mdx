...
- `src/modules/media/media.schema.ts` — Zod schemas for request validation.
- `src/modules/media/index.ts` — Express router for the media upload endpoints, mounted at `/api/v1/media`.
